...
describe('FlowController', () => {
  ...
  describe('wrap()', () => {
    ...
    it('should detect stalls and call callback', async () => {
      ...
      async function* mockStream() {
        await new Promise((resolve) => setTimeout(resolve, 500)); // Stall
        yield 'chunk1';
      }
    ...
    it('should inject fillers during stalls before first chunk', async () => {
      ...
      async function* mockStream() {
        await new Promise((resolve) => setTimeout(resolve, 500)); // Stall before first chunk
        yield 'chunk1';
      }
    ...
    it('should NOT inject fillers after first chunk', async () => {
      ...
      async function* mockStream() {
        ...
        await new Promise((resolve) => setTimeout(resolve, 500)); // Stall after first chunk
        yield 'chunk2';
      }
